...
suspend fun main() {
    val kord = Kord("MTA5NzU2NDIyMDA5MjA2NzkzMA.GApc16.yXOxMe-G3tpAe6CWEZLKO5oHN8FbFAizzGBQvo")
    val channelId = Snowflake(1097564220092067930)

    val config = OpenAIConfig(
        token = "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",
    )
...
fun Application.connectToChatGPT(openAI: OpenAI){
    routing {
        get("/chatgpt") {
            val chatCompletionRequest = ChatCompletionRequest(
                ...
                messages = listOf(
                    ChatMessage(
                        ...
                        content = "Hello from chatGPT, ask me a question"
                    ),
                    ChatMessage(
                        role = ChatRole.User,
                        content = "What is 2 + 2"
